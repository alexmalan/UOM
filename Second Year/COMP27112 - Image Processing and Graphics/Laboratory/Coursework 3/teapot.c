...
GLint mouseX, mouseY;
GLboolean s_pressed = false;


GLfloat white_light[] =     { -1.0, 1.0, 6.0, 1.0 };
GLfloat second_light[] = { -5.0, 9.0, 5.0, -1.0};
GLfloat light_position0[] = { 6.0, 5.0, 4.0, 8.0 };
GLfloat matSpecular[] =     { 1.0, 1.0, 3.0, 1.0 };
GLfloat matShininess[] =    { 55.0 };
GLfloat matSurface[] =      { 0.7, 1.0, 0.0, 0.0 };

BITMAPINFO *TexInfo; // Texture bitmap information
GLubyte    *TexBits; // Texture bitmap pixel bits

void initialise(void) {
   TexBits = LoadDIBitmap("teap.bmp", &TexInfo);
